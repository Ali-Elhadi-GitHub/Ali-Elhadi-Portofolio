      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto relative">
          ...
          {steps.map((step, index) => {
            ...
            return (
              <ScrollAnimation key={index} animation={isEven ? 'fade-right' : 'fade-left'} delay={index * 120}>
                <div className={`relative flex items-start mb-10 last:mb-0 ${isEven ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
                  <div className={`ml-16 md:ml-0 md:w-[calc(50%-2rem)] ${isEven ? 'md:pr-8 md:text-right' : 'md:pl-8'}`}>
                    <div className="p-5 bg-background rounded-xl border hover:shadow-md hover:border-primary/40 transition-all duration-300">
