  ...
  const projects = [
    {
      ...
      ar: {
        ...
        description: 'عمل شامل عبر الإنترنت: العلامة التجارية، التسويق، تصميم الأنظمة، واستراتيجية الاحتفاظ بالعملاء. دراسة حالة حية في بناء تجارة رقمية مربحة من الصفر.',
    ...
    },
    {
      ...
      ar: {
        title: 'لوحة معلومات الأعمال الذكية',
        subtitle: 'منصة تحليلات',
        description: 'لوحة معلومات شاملة لتتبع مؤشرات الأداء الرئيسية وسلوك العملاء وأداء المبيعات عبر القنوات الرقمية.',
        tags: ['تحليلات', 'تصور البيانات', 'ذكاء الأعمال'],
      },
      status: 'Coming Soon',
    },
    {
