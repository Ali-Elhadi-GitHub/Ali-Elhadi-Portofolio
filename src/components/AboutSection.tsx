      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <ScrollAnimation animation="fade" delay={150}>
            <div className="space-y-5 text-lg text-foreground/80 leading-relaxed mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-12">
            {specializations.map((item, index) => (
              <ScrollAnimation key={index} animation="scale" delay={index * 80}>
                <div className="flex items-center gap-3 p-4 bg-background rounded-xl border hover:shadow-md hover:border-primary/40 transition-all duration-300">
